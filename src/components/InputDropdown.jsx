...
export default function InputDropdown({ label }) {
  return (
    <div className="w-full relative flex flex-col gap-[9px]">
      <p>{label}</p>
      ...
      <menu className="absolute top-[72px] left-0 w-full list-none rounded-lg bg-white dark:bg-4 shadow-lg divide-y divide-5 dark:divide-3">
        <li>
          <button className="bg-transparent border-none outline-none text-base text-8 dark:text-white hover:text-1">
            Net 1 Day
          </button>
        </li>
        <li>
