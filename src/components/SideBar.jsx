...
export default function SideBar() {
  ...
  return (
    <aside className="fixed top-0 left-0 z-50 w-screen h-20 lg:h-screen lg:w-[103px] pr-6 lg:pb-6 lg:pr-0 flex lg:flex-col justify-between lg:rounded-tr-[20px] lg:rounded-br-[20px] bg-[#373B53]">
