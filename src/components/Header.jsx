  ...
  return (
    <header className="w-full flex justify-between">
      <div className="flex flex-col gap-[3px] md:gap-[6px]">
        <h1 className="text-lg md:text-xl text-8 dark:text-white font-bold">Invoices</h1>
        <p className="text-sm text-6 dark:text-5">{isBigScreen ? "There are 7 total invoices" : "7 invoices"}</p>
      </div>
