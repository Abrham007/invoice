...
export default function AddEditInvoice() {
  return (
    <section className="p-6 flex flex-col gap-[22px] bg-white dark:bg-12">
      ...
      <div className=" flex flex-col gap-[41px] ">
        ...
        <ItemList></ItemList>
        <div className="fixed bottom-0 left-0 w-screen  p-6 flex gap-2 justify-end items-center bg-white dark:bg-3 shadow-xl">
